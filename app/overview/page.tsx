            ...
            <div className="ov-aerial">
              ...
              {factoryData.buildings.map((b) => (
                ...
                >
                  ...
                  <div className="ov-bldg-label">{b.name.split(" — ")[0]}</div>
              ...
              <div className="ov-click-hint">👆 คลิกอาคารเพื่อดูรายละเอียด</div>
            </div>
          </div>
          ...
          <div className="ov-panel-body">
            ...
            >
              ...
              {mockAlerts
                .filter((a) => !a.resolved)
                .map((a) => (
                  <div key={a.id} className={`ov-aitem ov-aitem-${a.severity}`}>
